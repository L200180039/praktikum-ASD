...
c0 = mahasiswa('Guntur', 50, 'Sragen', 300000)
c1 = mahasiswa('Kelvin', 23, 'Boylali', 200000)
c2 = mahasiswa('Anton', 13, 'Makasar', 700000)
c3 = mahasiswa('Lovi', 79, 'Pati', 600000)
c4 = mahasiswa('Dava', 48, 'Solo', 500000)
c5 = mahasiswa('Boi', 27, 'Demak', 400000)
c6 = mahasiswa('Isyana', 88, 'Jepara', 100000)
c7 = mahasiswa('Aan', 72, 'Soolo', 450000)
c8 = mahasiswa('Dodi', 92, 'Jember', 800000)
c9 = mahasiswa('Amal', 69, 'Grogol', 850000)
